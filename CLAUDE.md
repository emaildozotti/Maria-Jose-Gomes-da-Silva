# LP -- Maria Jose Gomes da Silva

Repositorio standalone da landing page de Maria Jose Gomes da Silva.
...
- **Cliente:** Maria Jose Gomes da Silva
- **GitHub:** https://github.com/emaildozotti/Maria-Jose-Gomes-da-Silva
- **Vercel:** https://maria-jose-gomes.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Maria Jose Gomes da Silva ao ar"
...
- O remote `origin` = `emaildozotti/Maria-Jose-Gomes-da-Silva` -- nao alterar
