...
const depoimentos = [
  {
    ...
    texto: 'Eu achava que minha ansiedade era normal depois da traição. Passava horas verificando o celular dele, os aplicativos, as notificações. Com a Maze entendi que eu estava tentando controlar o que não podia ser controlado. Em 4 meses aprendi a confiar, não cegamente nele, mas em mim mesma. Isso mudou tudo.',
  ...
  },
  {
    ...
    texto: 'Meu marido e eu já tínhamos marcado consulta com advogado. Depois de 11 anos e dois filhos, parecia que não tinha mais jeito. Uma amiga indicou a Maze e fomos por desencargo de consciência. Oito meses depois, não só não separamos como estamos em um casamento que nunca tivemos antes. Ela tem um jeito de fazer você se ver no lugar do outro sem se anular.',
